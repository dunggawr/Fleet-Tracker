...
export class InitialSchema1778427114680 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'driver', 'dispatcher')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."drivers_status_enum" AS ENUM('available', 'on_trip', 'off_duty')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."vehicles_type_enum" AS ENUM('small', 'medium', 'large')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."vehicles_status_enum" AS ENUM('available', 'delivering', 'maintenance')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."orders_status_enum" AS ENUM('pending', 'assigned', 'picked_up', 'delivering', 'delivered', 'failed', 'cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "trip_orders" ("trip_id" uuid NOT NULL, "order_id" uuid NOT NULL, "sequence" integer NOT NULL, CONSTRAINT "PK_f32e9c62c19ffa064a33272b981" PRIMARY KEY ("trip_id", "order_id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."trips_status_enum" AS ENUM('pending', 'accepted', 'in_progress', 'completed', 'cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "gps_locations" ("id" BIGSERIAL NOT NULL, "vehicle_id" uuid NOT NULL, "trip_id" uuid, "location" geography(Point,4326) NOT NULL, "speed_kmh" numeric, "heading" numeric, "recorded_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_1395375cf4a8d3d08d682e7dff7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_3ed605b32552f6f03cdc154153" ON "gps_locations" ("vehicle_id", "recorded_at") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."alerts_type_enum" AS ENUM('speed_violation', 'route_deviation', 'abnormal_stop', 'incident')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "vehicles" ADD CONSTRAINT "FK_9c2e0a8772c9e43b32f57bfcfcc" FOREIGN KEY ("driver_id") REFERENCES "drivers"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "trip_orders" ADD CONSTRAINT "FK_49dcfadcd6516ce31866f31eacf" FOREIGN KEY ("trip_id") REFERENCES "trips"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "trip_orders" ADD CONSTRAINT "FK_eb3ae7e919ef2a41341d99b13d6" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "gps_locations" ADD CONSTRAINT "FK_a6fd64c4d252272725d9716af40" FOREIGN KEY ("vehicle_id") REFERENCES "vehicles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "gps_locations" ADD CONSTRAINT "FK_ef70b89fb4eb8f22d5e6adbdd08" FOREIGN KEY ("trip_id") REFERENCES "trips"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" ADD CONSTRAINT "FK_e9e6791b945e74a123fc1316381" FOREIGN KEY ("trip_id") REFERENCES "trips"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" ADD CONSTRAINT "FK_74dd85f46da0c401a52b82aa8f5" FOREIGN KEY ("vehicle_id") REFERENCES "vehicles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" ADD CONSTRAINT "FK_6e903097eae826928bc6030b5c5" FOREIGN KEY ("driver_id") REFERENCES "drivers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "driver_kpi" ADD CONSTRAINT "FK_8122b6c9ed335bccb4efd0c4c3e" FOREIGN KEY ("driver_id") REFERENCES "drivers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "driver_kpi" DROP CONSTRAINT "FK_8122b6c9ed335bccb4efd0c4c3e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" DROP CONSTRAINT "FK_6e903097eae826928bc6030b5c5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" DROP CONSTRAINT "FK_74dd85f46da0c401a52b82aa8f5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "alerts" DROP CONSTRAINT "FK_e9e6791b945e74a123fc1316381"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gps_locations" DROP CONSTRAINT "FK_ef70b89fb4eb8f22d5e6adbdd08"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gps_locations" DROP CONSTRAINT "FK_a6fd64c4d252272725d9716af40"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "trip_orders" DROP CONSTRAINT "FK_eb3ae7e919ef2a41341d99b13d6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "trip_orders" DROP CONSTRAINT "FK_49dcfadcd6516ce31866f31eacf"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3ed605b32552f6f03cdc154153"`,
    );
